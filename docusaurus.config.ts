...
const config: Config = {
  ...
  url: 'https://ellendan.com',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/book-chanlun/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://ellendan.com',
          label: "EllenDan's Blog",
          position: 'right',
        },
      ],
    },
    footer: {
      style: 'dark',
      copyright: `Copyright © ${new Date().getFullYear()} EllenDan. Built with Docusaurus.`,
    },
    prism: {
